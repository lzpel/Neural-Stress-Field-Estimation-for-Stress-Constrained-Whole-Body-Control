...
fn setup(
    ...
    let shapes = [
        ...
        //meshes.add(Segment3d::new(point1, point2)),
        //meshes.add(Polyline3d::new(vec![Vec3::new(-0.5, 0.0, 0.0),Vec3::new(0.5, 0.0, 0.0),Vec3::new(0.0, 0.5, 0.0),])),
    ];
    ...
    commands.spawn((
        Camera3d::default(),
        Transform::from_xyz(0.0, 7.*10., 14.0*10.).looking_at(Vec3::new(0., 1., 0.), Vec3::Y),
    ));
