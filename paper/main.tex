...
\usepackage{luatexja}%少なくとも\mojiparlineの単位\zwの定義に必要
\usepackage{amsmath,amssymb,empheq,bm}%数式
\usepackage{hyperref}
\usepackage{multirow}

%書くべきページ数，11日後に64pとそこそこになる
%0 + 1 * https://lzpel.github.io/calendar/passed?date=2025-10-17
%\{subsec:\w+\}章

% 図表のサイズはgravit-facebookが12cm，横並びは8cmで統一
